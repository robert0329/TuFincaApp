...
var UsuarioService = /** @class */ (function () {
    ...
    UsuarioService.prototype.getEmail = function (email) {
        ...
        return this.http.get(url).pipe(Object(__WEBPACK_IMPORTED_MODULE_1_rxjs_operators__["tap"])(function (email) { return _this.log(''); }), Object(__WEBPACK_IMPORTED_MODULE_1_rxjs_operators__["catchError"])(this.handleError('finca')));
    };
    UsuarioService.prototype.getPassword = function (password) {
        var _this = this;
        var url = this.Urlgetp + "/" + password;
        return this.http.get(url).pipe(Object(__WEBPACK_IMPORTED_MODULE_1_rxjs_operators__["tap"])(function (password) { return _this.log(''); }), Object(__WEBPACK_IMPORTED_MODULE_1_rxjs_operators__["catchError"])(this.handleError("password=" + password)));
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_parcela_parcela__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_productos_productos__ = __webpack_require__(143);
...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.login = function () {
        var _this = this;
        this.auth.login(this.registerCredentials).subscribe(function (value) {
            if (value) {
                _this.showLoading();
